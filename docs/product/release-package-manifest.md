...
| `WeChatPlus.Install.exe` | Installer | Independent install entry that copies manifest-listed runtime files and creates the Start Menu shortcut placeholder. |
