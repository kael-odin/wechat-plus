...
| `WeChatPlus.Install.exe` | Installer | Independent install entry that copies manifest-listed runtime files, creates a Start Menu `.lnk`, and can explicitly write HKCU uninstall registration. |
